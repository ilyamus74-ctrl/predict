...
# Сортируем по стране (tags) и времени
news = news.sort_values(['tags', 'published_at']).reset_index(drop=True)
# Время следующей новости по той же стране
news['t_next_news'] = news.groupby('tags')['published_at'].shift(-1)
